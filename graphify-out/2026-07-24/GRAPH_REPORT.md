...
## Summary
- 726 nodes · 1057 edges · 50 communities (47 shown, 3 thin omitted)
...
Cohesion: 0.11
Nodes (15): activeStyle, coverCd, dateDots, elVars, emit, firstEvent, heroPhoto, heroStyle (+7 more)

### Community 2 - "Community 2"
Cohesion: 0.12
Nodes (8): activeLayout, layout, LAYOUTS, now, numeralStyle, parts, props, timer

### Community 3 - "Community 3"
Cohesion: 0.16
Nodes (11): SECTIONS, { data: themes }, { form, applyInvitation, applyLook }, handleSlideshowUpload(), handleUpload(), { invitation, isLoading, isError, error }, saveErr, saveOk (+3 more)
...
Cohesion: 0.07
Nodes (25): gate, invitationId, { list, setApproved, remove }, base(), useGuestbookAdmin(), useActiveInvitation(), useGuestbook(), useMyInvitations() (+17 more)
...
Cohesion: 0.22
Nodes (7): auth, MENU, router, sidebarOpen, theme, csrf(), useAuthStore
...
Cohesion: 0.24
Nodes (7): { data, isLoading, isError }, useThemes(), cases, load(), loading, removeCase(), api
...
Cohesion: 0.11
Nodes (14): ELEMENTS, ELEMENTS, ELEMENTS, ELEMENTS, ELEMENTS, ELEMENTS, GUESTBOOK_ELEMENTS, RSVP_ELEMENTS (+6 more)
...
Cohesion: 0.13
Nodes (8): assetUrl(), emit, emit, emit, emit, emit, emit, ICONS
...
Cohesion: 0.07
Nodes (14): FONT_CATEGORY_VAR, hexToRgba(), toEmbedUrl(), toMapsEmbed(), useThemeOptions(), activeStyle, props, STYLES (+6 more)

### Community 52 - "invitationFormOptions.js"
Cohesion: 0.24
Nodes (9): bgSource, props, HERO_TEXT_ELEMENTS, ACCENT_FONTS, BODY_FONTS, CARD_STYLES, FONT_CATEGORIES, HEADING_FONTS (+1 more)
...
## Knowledge Gaps
- **359 isolated node(s):** `name`, `private`, `type`, `dev`, `build` (+354 more)
...
- **Why does `assetUrl()` connect `GiftSection.vue` to `GallerySection.vue`, `Community 2`, `useReveal.js`, `UcapanDoa.vue`, `Community 6`, `Community 11`, `UcapanDoa.vue`, `Community 12`, `CoverSection.vue`, `GaleriFoto.vue`, `CountdownSection.vue`, `_template/Layout.vue`, `CoupleSection.vue`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `api` connect `client.js` to `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 9`, `client.js`, `GaleriFoto.vue`, `Rsvp.vue`, `index.js`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `useActiveInvitation()` connect `Community 5` to `Community 3`, `GaleriFoto.vue`?**
