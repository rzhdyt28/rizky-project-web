<script setup>
/** Hero -- gaya "split": dua kolom di layar lebar (teks kiri, foto berbingkai kanan); bertumpuk di HP. */
...
<template>
  <div class="grid items-center w-full gap-6 px-6 py-10 text-center mild-cover sm:grid-cols-2 sm:text-left">
    ...
    <div class="flex flex-col items-center gap-4 sm:order-1 sm:items-start">
      ...
      <div v-if="hero.dresscodeEnabled && hero.dresscode" class="mild-dresscode sm:items-start" :style="{ color: 'var(--hero-el-dresscode-color)' }">
      ...
      <button class="c-btn inline-flex cursor-pointer items-center gap-2 border-0 px-7 py-3 uppercase tracking-[0.12em] transition hover:opacity-90"
