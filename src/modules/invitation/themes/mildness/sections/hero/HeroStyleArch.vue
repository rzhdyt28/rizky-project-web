<script setup>
/** Hero -- gaya "arch": foto besar berbingkai lengkung (arch) di atas nama, editorial & elegan. */
...
<template>
  <div class="relative flex flex-col items-center w-full gap-4 px-6 py-10 text-center mild-cover">
    <div v-if="heroPhoto" class="mild-arch">
      <img :src="assetUrl(heroPhoto)" :alt="`${invitation.bride_name} & ${invitation.groom_name}`" loading="lazy" class="object-cover w-full h-full" />
    </div>
