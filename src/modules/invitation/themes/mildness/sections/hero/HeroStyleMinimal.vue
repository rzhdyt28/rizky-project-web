<script setup>
/** Hero -- gaya "minimal": nama besar + garis tipis emas + tanggal + tombol, sangat bersih.
    Juga dipakai sebagai FALLBACK untuk hero.style yang tidak dikenal (lihat dispatcher Cover.vue). */
defineProps({
...
<template>
  <div class="relative flex flex-col items-center w-full gap-3 px-6 py-14 text-center mild-cover">
