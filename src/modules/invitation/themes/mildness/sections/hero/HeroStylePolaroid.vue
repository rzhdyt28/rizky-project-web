<script setup>
/** Hero -- gaya "polaroid": foto gaya polaroid dengan bingkai putih, sedikit miring, caption di bawah foto. Playful/vintage. */
...
<template>
  <div class="relative flex flex-col items-center w-full gap-4 px-6 py-10 text-center mild-cover">
    <div v-if="heroPhoto" class="mild-polaroid">
