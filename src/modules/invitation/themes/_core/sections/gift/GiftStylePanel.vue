  ...
  <div class="mx-auto grid max-w-sm gap-3">
    ...
    >
      <template v-if="g.type === 'address'">
        <h4 class="mb-1 text-base" :style="{ fontFamily: 'var(--el-name-font, var(--t-font-head))', color: 'var(--el-name-color, var(--t-accent))', fontSize: 'var(--el-name-size)' }">
          Alamat Pengiriman
        </h4>
      ...
      <template v-else>
        <h4 class="text-base" :style="{ fontFamily: 'var(--el-name-font, var(--t-font-head))', color: 'var(--el-name-color, var(--t-accent))', fontSize: 'var(--el-name-size)' }">
          {{ g.provider }}
        </h4>
